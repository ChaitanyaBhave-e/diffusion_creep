...
[Materials]
  ...
  [abs_rate_11]
    type = DerivativeParsedMaterial
    property_name = 'abs_rate_11'
    coupled_variables = 'c_v mu s11_aux s22_aux'
    material_property_names = 'D M_scalar V_a'
    expression = '-1*(mu-V_a* s22_aux)/D'
  []

  [abs_rate_22]
    type = DerivativeParsedMaterial
    property_name = 'abs_rate_22'
    coupled_variables = 'c_v mu s11_aux s22_aux'
    material_property_names = 'D M_scalar V_a'
    expression = '-1*(mu-V_a* s11_aux)/D'
  []
  [elasticity]
