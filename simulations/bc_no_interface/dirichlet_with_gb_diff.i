...
[Materials]
  ...
  [gb_mat]
    ...
    coupled_variables = 'eta eta1'
    property_name = 'gb_mat'
    expression = '16*eta^2*eta1^2'
    # expression = 'bnds:=eta^2 + (1-eta)^2;0.5*(1-tanh((bnds-0.75)*2*atanh(0.8)/0.11 ) )
  []
  ...
  #   type = DerivativeParsedMaterial
  #   property_name = 'M_v'
  #   material_property_names = 'chi_v'
  #   expression = '0.1*chi_v'
  ...
  [diffusivity]
    ...
    gb = gb
    bulk_parameter = '0.0477220888'
    gb_parameter = '${fparse 0.0477220888 * ( 10 - 1) * (  0.5 / ${GlobalParams/int_width} ) }'
    gb_normal_tensor_name = gb_normal
  ...
  #   expression = 'D_b:=1.56e-4*exp(-289e3/R/T)*1e18;D_b*(1-gb_mat) + gb_mat*D_b*1e6*(0.5/${GlobalParams/int_width})' #nm^2/s
  #   outputs = exodus
  # []
  # [diffusivity]
