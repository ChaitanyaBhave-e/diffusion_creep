...
[Functions]
  [pressure_func]
    type = ParsedFunction
    symbol_names = 'P0'
    symbol_values = '${fparse 100 * 10^6 * 6.242e-9}'
    expression = -P0
  []
[]
...
[Materials]
  ...
  [aniso_tensor]
    ...
    gb = gb
    bulk_parameter = 0.1
    gb_parameter = '${fparse ( 1 - 0.1) * (  5e-4 / ${GlobalParams/int_width} ) + 0.1 }'
  ...
  [diffusivity]
    ...
    gb = gb
    bulk_parameter = 0.1
    gb_parameter = '1.0' #${fparse ( 1e4 - 0.1) * (  5e-4 / ${GlobalParams/int_width} ) + 0.1 }
    gb_normal_tensor_name = gb_normal
